...
import com.example.ifound.fragments.adapters.EditLostAdopter;
...
public class LostPostUser extends Fragment {

    private RecyclerView mRecyclerView;
    private EditLostAdopter mAdapter;
    ...
    private List<Lostitem> mUploads;
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        View v = inflater.inflate(R.layout.lost_post_user, container, false);
        ...
        mAdapter = new EditLostAdopter(getContext(), mUploads);
        ...
        mDatabaseRef = FirebaseDatabase.getInstance().getReference("Lost Items");
        ...
        mDatabaseRef.orderByChild("email").equalTo(Email).addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                ...
                for (DataSnapshot postSnapshot : dataSnapshot.getChildren()) {
                    Lostitem upload = postSnapshot.getValue(Lostitem.class);
