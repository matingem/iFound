...
public class EditPostAdopter extends RecyclerView.Adapter <EditPostAdopter.ViewHolder>{
    ...
    public @NotNull ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        View listItem= layoutInflater.inflate(R.layout.found_itemview_edit, parent, false);
    ...
    public void onBindViewHolder(ViewHolder holder, int position) {
       ...
       selectedKey = founditem.getKey();
        ...
        }else if (update.equals("Returned to Owner")){
        ...
        holder.next.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                PopupMenu popup = new PopupMenu(mContext,holder.next);
                ...
                popup.setOnMenuItemClickListener(new PopupMenu.OnMenuItemClickListener() {
                    public boolean onMenuItemClick(MenuItem item) {
                        if (item.getItemId() == R.id.one) {
                            ...
                            DatabaseReference classicalMechanicsRef = rootRef.child("Found Items");
                            Query query = classicalMechanicsRef.orderByChild("key").equalTo(selectedKey);
                            ValueEventListener valueEventListener = new ValueEventListener() {
                                @Override
                                public void onDataChange(DataSnapshot dataSnapshot) {
                                    for(DataSnapshot ds : dataSnapshot.getChildren()) {
                                        ds.child("status").getRef().setValue("Returned to Owner");
                                        holder.rto.setVisibility(View.VISIBLE);
