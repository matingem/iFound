...
public class Founditem1
{
    ...
    public Founditem1(String title, String discriotion, String email, String location, String time, String city, String imageurl, String status, String key) {
        this.title = title;
